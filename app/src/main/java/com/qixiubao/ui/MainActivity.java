...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        requireData.token = "4a55c0670f02c0b6ce220e8f837238d4";
        requireData.access_time = "1585641037";
        requireData.param = "LKL450T6XZ00Uwa0aJy9jjJzbneuYdIeaNs6YZy9zvqxyuq-_ucZ_jz7z3k4UdC_V23zlJy-gJz7z3GxZdAebdokzvRziFizjZ0q";
        ...
        SimpleEpcCatalogActivity.setOnSelectedCallBack(new SimpleEpcCatalogActivity.OnSelectedCallBack() {
            ...
            public void onSelected(SimpleEpcDetail data, int position) {
                ...
                Log.d("Main", "onSelected=" + listBean.caption);
            }
        });
